...
export default {
    ...
    head: {
        ...
        meta: [
            ...
            {
                name: process.env.GOOGLE_SITE_VERIFICATION_TOKEN ? 'google-site-verification' : '',
                content: process.env.GOOGLE_SITE_VERIFICATION_TOKEN ? process.env.GOOGLE_SITE_VERIFICATION_TOKEN : ''
            }
        ],
        link: [
